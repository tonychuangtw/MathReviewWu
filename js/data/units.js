...
{ id:'u55', book:5, sec:'3-2', title:'外心、內心、重心', page:94, concepts:[
  ...
  { id:'u55c5', title:'特殊三角形的三心關係與多邊形的外接圓、內切圓', body:
    '<p>5、特殊三角形的三心關係：1. 等腰三角形的外心、內心與重心<b class="key">三心共線</b>（都在頂角平分線上）；2. 正三角形的外心、內心與重心<b class="key">三心共點</b>；3. 直角三角形的外心（斜邊中點）、垂心（直角頂點）與重心共線。</p>'+
    '<p>6、多邊形的外接圓與外心：如果一個多邊形的<b class="key">每個頂點</b>都剛好在同一個圓上，此多邊形稱為圓的<b class="key">內接多邊形</b>，這個圓稱為多邊形的<b class="key">外接圓</b>，圓心稱為<b class="key">外心</b>。</p>'+
    '<p>7、多邊形的內切圓與內心：如果多邊形<b class="key">每邊</b>都與內部一圓<b class="key">相切</b>，此多邊形稱為圓的<b class="key">外切多邊形</b>，這個圓稱為<b class="key">內切圓</b>，圓心稱為<b class="key">內心</b>。</p>'+
    '<p>8、正多邊形的外心和內心：(1) 正多邊形都有外心與內心，且外心與內心是<b class="key">同一點</b>；(2) 正六邊形可等分成 <b class="key">6 個正三角形</b>。</p>'+
    '<p>9、正多邊形的對稱軸：(1) 邊數是<b class="key">奇數</b>時，對稱軸是各邊的<b class="key">中垂線</b>，同時也是各內角的<b class="key">角平分線</b>；(2) 邊數是<b class="key">偶數</b>時，對稱軸是各邊的<b class="key">中垂線</b>或各內角的<b class="key">角平分線</b>。</p>',
    examples:[
      { q:'正五邊形有幾條對稱軸？正六邊形呢？',
        steps:['正 $n$ 邊形有 $n$ 條對稱軸。','5 條；6 條（偶數邊：3 條中垂線＋3 條角平分線）。'],
        ans:'5 條；6 條' },
      { q:'正六邊形邊長 4，其面積可拆成 6 個正三角形，求面積。',
        steps:['每個正三角形面積 $=\\dfrac{\\sqrt{3}}{4}\\times 16=4\\sqrt{3}$。','$6\\times 4\\sqrt{3}=24\\sqrt{3}$。'],
        ans:'$24\\sqrt{3}$' } ] }
]},

{ id:'u56', book:6, sec:'1-1', title:'二次函數的圖形', page:98, concepts:[
  { id:'u56c1', title:'複習：函數與其分類', body:
    '<p>函數：1、如果每一個 $x$ 都有一個 $y$ 與之對應（而且只有一個），則稱 $y$ 是 $x$ 的函數，以 $y=f(x)$ 表示；2、圖形上，由 $x$ 軸畫垂線，只與圖形交於一點，則為函數的圖形。</p>'+
    '<p>分類：零函數、零次函數 → 常數函數；一次函數 $y=ax+b$ → 線型函數；<b class="key">二次函數</b>：形如 <b class="key">$y=ax^2+bx+c$</b>，其中 <b class="key">$a\\neq 0$</b> 且 $x$ 的最高次數為 2；三次函數：$y=ax^3+bx^2+cx+d$。</p>',
    examples:[
      { q:'$y=3x^2-2x+1$、$y=(x-1)^2-x^2$ 各是幾次函數？',
        steps:['前者最高次 2 且係數 3≠0 → 二次函數。','後者展開 $=-2x+1$ → 一次函數（$x^2$ 消掉了）。'],
        ans:'二次函數；一次函數' } ] },

  { id:'u56c2', title:'二次函數繪圖要點', body:
    '<p>1、圖形為<b class="key">拋物線</b>（<b class="key">曲線</b>非直線）。</p>'+
    '<p>2、圖形沒有<b class="key">尖點</b>。</p>'+
    '<p>3、二次函數為<b class="key">線對稱</b>圖形。</p>'+
    '<p>4、每次繪圖描 <b class="key">5</b> 點。</p>'+
    '<p>5、從<b class="key">最高點</b>（即<b class="key">頂點</b>）或<b class="key">最低點</b>（即<b class="key">頂點</b>）開始描點，左右對稱各取兩點。</p>'+
    '<p>6、對稱軸方程式（$x=$ 定值）亦為<b class="key">頂點</b>的 $x$ 座標。</p>',
    examples:[
      { q:'畫 $y=x^2-4x+3$ 該從哪個點開始描？',
        steps:['對稱軸 $x=\\dfrac{4}{2}=2$，代入得 $y=-1$。','從頂點 $(2,-1)$ 開始，左右各取兩點（如 $x=0,1,3,4$）。'],
        ans:'頂點 $(2,-1)$' } ] },

  { id:'u56c3', title:'開口方向與開口大小', body:
    '<p>四、<b class="key">開口方向</b>結論：</p>'+
    '<p>1、$x^2$ 項係數為 ＋ ⇒ 圖形<b class="key">開口向上</b> ⇒ $y$ 有<b class="key">最低點</b>，即 $y$ 有<b class="key">最小值</b>。</p>'+
    '<p>2、$x^2$ 項係數為 － ⇒ 圖形<b class="key">開口向下</b> ⇒ $y$ 有<b class="key">最高點</b>，即 $y$ 有<b class="key">最大值</b>。</p>'+
    '<p>五、<b class="key">開口大小</b>結論（觀察 $x^2$ 項係數 $a$）：</p>'+
    '<p>1、當 $|a|$ 愈大，圖形的<b class="key">開口愈小</b>；2、當 $|a|$ 愈小，圖形的<b class="key">開口愈大</b>；3、$y=2x^2$ 與 $y=-2x^2$ 開口大小<b class="key">相等</b>（方向相反）。</p>',
    examples:[
      { q:'$y=3x^2$、$y=\\dfrac{1}{2}x^2$、$y=-3x^2$ 三圖形，誰開口最大？誰有最高點？',
        steps:['$|a|$ 最小的開口最大 → $y=\\dfrac{1}{2}x^2$。','係數負的開口向下有最高點 → $y=-3x^2$。'],
        ans:'$y=\\dfrac{1}{2}x^2$ 開口最大；$y=-3x^2$ 有最高點' } ] },

  { id:'u56c4', title:'圖形的平移與 y=a(x−h)²+k', body:
    '<p>六、<b class="key">上下平移</b>（觀察常數項 $k$）：$k>0$ 向<b class="key">上</b>平移；$k<0$ 向<b class="key">下</b>平移。</p>'+
    '<div class="inline-ex">例：$y=-3x^2+2$ 可由 $y=-3x^2$ 向上平移 2；$y=\\dfrac{1}{2}x^2-3$ 可由 $y=\\dfrac{1}{2}x^2$ 向下平移 3。</div>'+
    '<p>七、<b class="key">左右平移</b>（觀察完全平方項中的 $h$）：$y=a(x+h)^2$ 中 $h>0$ 向<b class="key">左</b>平移；$y=a(x-h)^2$（$h>0$）向<b class="key">右</b>平移。</p>'+
    '<div class="inline-ex">例：$y=-(x+2)^2$ 可由 $y=-x^2$ 向左平移 2；$y=2(x-3)^2$ 可由 $y=2x^2$ 向右平移 3。</div>'+
    '<p>八、上下左右平移：$y=2x^2$ 頂點 $(0,0)$ ⇒ 向<b class="key">右</b>平移 3 單位得 $y=2(x-3)^2$ 頂點 $(3,0)$ ⇒ 再向<b class="key">上</b>平移 5 單位得 $y=2(x-3)^2+5$ 頂點 $(3,5)$。</p>'+
    '<p>$y=a(x-h)^2+k$ 的圖形特性：(1) 圖形都是拋物線，頂點坐標 <b class="key">$(h,k)$</b>，對稱軸為直線 <b class="key">$x=h$</b>；(2) 圖形可由 $y=ax^2$ 平移而得，頂點由 $(0,0)$ 平移到 $(h,k)$；(3) 圖形的開口方向、大小與 $y=ax^2$ 相同。</p>',
    fig:'u56-shift',
    examples:[
      { q:'$y=-2(x+4)^2-1$ 的頂點與對稱軸？由 $y=-2x^2$ 怎麼平移？',
        steps:['寫成 $y=a(x-h)^2+k$：$h=-4$、$k=-1$。','頂點 $(-4,-1)$，對稱軸 $x=-4$。','向左 4、向下 1。'],
        ans:'頂點 $(-4,-1)$；$x=-4$；左 4 下 1' } ] }
]},

{ id:'u57', book:6, sec:'1-2', title:'配方法與二次函數的極值', page:101, concepts:[
  { id:'u57c1', title:'二次函數的極值', body:
    '<p>複習：$y=a(x-h)^2+k$，頂點 <b class="key">$(h,k)$</b>、對稱軸 <b class="key">$x=h$</b>。</p>'+
    '<p>1、當 $a>0$，二次函數開口<b class="key">向上</b>，圖形有<b class="key">最低點</b>即<b class="key">最小值</b>，發生在頂點的位置：當 $x=h$ 時，$y$ 有<b class="key">最小值 $k$</b>。</p>'+
    '<p>2、當 $a<0$，二次函數開口<b class="key">向下</b>，圖形有<b class="key">最高點</b>即<b class="key">最大值</b>：當 $x=h$ 時，$y$ 有<b class="key">最大值 $k$</b>。</p>',
    examples:[
      { q:'$y=-3(x-2)^2+7$ 有最大值還是最小值？是多少？',
        steps:['$a=-3<0$ 開口向下 → 最大值。','$x=2$ 時最大值 $7$。'],
        ans:'最大值 7（在 $x=2$）' } ] },

  { id:'u57c2', title:'配方法求頂點式', body:
    '<p>二次函數非 $y=a(x-h)^2+k$ 型式時，利用<b class="key">配方法</b>求得：</p>'+
    '<p>$y=ax^2+bx+c=a\\left(x^2+\\dfrac{b}{a}x\\right)+c=a\\left(x+\\dfrac{b}{2a}\\right)^2+\\dfrac{4ac-b^2}{4a}$。</p>'+
    '<p>頂點：<b class="key">$\\left(\\dfrac{-b}{2a},\\dfrac{4ac-b^2}{4a}\\right)$</b>，對稱軸：<b class="key">$x=\\dfrac{-b}{2a}$</b>。</p>',
    examples:[
      { q:'用配方法把 $y=x^2-6x+11$ 化成頂點式並求極值。',
        steps:['$y=(x^2-6x+9)+11-9=(x-3)^2+2$。','開口向上 → $x=3$ 時最小值 2。'],
        ans:'$y=(x-3)^2+2$；最小值 2' },
      { q:'$y=2x^2+8x+3$ 的頂點與對稱軸？',
        steps:['$x=\\dfrac{-8}{2\\times 2}=-2$。','$y=2\\times 4-16+3=-5$ → 頂點 $(-2,-5)$。'],
        ans:'頂點 $(-2,-5)$；對稱軸 $x=-2$' } ] },

  { id:'u57c3', title:'二次函數與兩軸交點', body:
    '<p>1、與 <b class="key">$y$ 軸交點</b>討論：令 <b class="key">$x=0$</b> ⇒ $y=c$ ⇒ 交點 <b class="key">$(0,c)$</b>。</p>'+
    '<p>2、與 <b class="key">$x$ 軸交點</b>討論：令 <b class="key">$y=0$</b> ⇒ 即 $ax^2+bx+c=0$ ⇒ <b class="key">交點數目就是 $x$ 解的數目</b>：</p>'+
    '<p>(1) 判別式 $b^2-4ac>0$：方程式有<b class="key">兩個相異解</b> → 圖形與 $x$ 軸有<b class="key">兩個交點</b>。</p>'+
    '<p>(2) 判別式 $b^2-4ac=0$：方程式有<b class="key">重根</b> $x=\\dfrac{-b}{2a}$ → 圖形與 $x$ 軸恰有<b class="key">一個交點</b>，也就是頂點 $\\left(\\dfrac{-b}{2a},0\\right)$。</p>'+
    '<p>(3) 判別式 $b^2-4ac<0$：方程式<b class="key">無解</b> → 圖形與 $x$ 軸<b class="key">沒有交點</b>。</p>'+
    '<p>討論Ⅱ（從開口與頂點看）：兩個交點：開口向上且頂點 $y<0$，或開口向下且頂點 $y>0$；一個交點：頂點 $y=0$；無交點：開口向上且頂點 $y>0$，或開口向下且頂點 $y<0$。</p>',
    examples:[
      { q:'$y=x^2-4x+5$ 與 $x$ 軸有幾個交點？與 $y$ 軸交於哪？',
        steps:['判別式 $16-20=-4<0$ → 無交點。','$x=0$ → $(0,5)$。'],
...
{ id:'u58', book:6, sec:'1-3', title:'二次函數的應用', page:103, concepts:[
  { id:'u58c1', title:'二次函數極值應用問題的解題步驟', body:
    '<p>解二次函數最大值與最小值的應用問題有以下<b class="key">步驟</b>：</p>'+
    '<p>(1) <b class="key">設未知數</b>：依題意假設未知數 $x$、$y$。</p>'+
    '<p>(2) <b class="key">列式</b>：依題意列出 $x$ 的二次函數。</p>'+
    '<p>(3) <b class="key">求值</b>：利用配方法，求出二次函數的最大值或最小值。</p>'+
    '<p>(4) <b class="key">作答</b>：依題意回答問題。</p>',
    examples:[
      { q:'用 40 公尺圍籬圍一個長方形菜園，長寬各多少時面積最大？最大面積是多少？',
        steps:['設寬 $x$，則長 $=20-x$，面積 $y=x(20-x)$。','$y=-x^2+20x=-(x-10)^2+100$。','$x=10$ 時最大面積 100 → 長寬各 10 公尺（正方形）。'],
        ans:'長寬各 10 公尺；最大面積 100 平方公尺' },
      { q:'某商品單價 $x$ 元時日銷額 $y=-2x^2+120x$，單價多少時銷額最大？',
        steps:['$y=-2(x^2-60x)=-2(x-30)^2+1800$。','$x=30$ 時最大 1800。'],
        ans:'30 元；最大銷額 1800 元' } ] }
]},

{ id:'u59', book:6, sec:'2-1', title:'角柱與圓柱', page:103, concepts:[
  { id:'u59c1', title:'長方體與正方體', body:
    '<p>1、<b class="key">長方體</b>：有 <b class="key">6</b> 個面、<b class="key">8</b> 個頂點、<b class="key">12</b> 條稜邊。</p>'+
    '<p>2、<b class="key">正方體</b>：是長、寬、高皆等長的長方體，它同樣有 <b class="key">6</b> 個面、<b class="key">8</b> 個頂點、<b class="key">12</b> 條稜邊。（正方體有 11 種展開圖。）</p>',
    examples:[
      { q:'長方體長 5、寬 4、高 3，稜邊總長是多少？',
        steps:['長寬高各 4 條：$4\\times(5+4+3)$。','$=48$。'],
        ans:'$48$' } ] },

  { id:'u59c2', title:'空間中的垂直', body:
    '<p>1、<b class="key">兩平面</b>的垂直關係：利用<b class="key">長方體</b>檢驗平面與平面是否互相垂直（貼合無空隙＝垂直，有空隙＝不垂直）。</p>'+
    '<p>2、<b class="key">直線與平面</b>的垂直關係：利用<b class="key">長方體</b>檢驗平面與直線是否互相垂直。</p>'+
    '<p>3、若直線 $L$ 與平面 $S$ 互相垂直，且交點為 $P$，則平面 $S$ 上通過 $P$ 點的<b class="key">任一條直線都與 $L$ 垂直</b>。</p>',
    examples:[
      { q:'旗桿垂直於地面，地面上通過桿腳的任何直線與旗桿是什麼關係？',
        steps:['直線與平面垂直 → 平面上過交點的任一直線都與它垂直。'],
        ans:'都互相垂直' } ] },

  { id:'u59c3', title:'柱體的體積、表面積與角柱', body:
    '<p>1、<b class="key">體積＝底面積 × 柱高</b>。</p>'+
    '<p>2、<b class="key">表面積＝底面積（上下兩底）＋側面積</b>。</p>'+
    '<p>3、<b class="key">角柱</b>：(1) <b class="key">直角柱</b>：<b class="key">底面與側面垂直</b>——① 兩全等的<b class="key">底面</b>；② 底面 ⊥ <b class="key">側面</b>；③ 側面為<b class="key">長方形</b>。(2) <b class="key">斜角柱</b>：<b class="key">底面不垂直側面</b>。(3) 展開圖：三角柱、四角柱、五角柱皆為兩底面＋一排長方形側面。</p>',
    examples:[
      { q:'正三角柱底面邊長 4（底面積 $4\\sqrt{3}$）、高 10，求體積。',
        steps:['體積＝底面積×柱高。','$4\\sqrt{3}\\times 10=40\\sqrt{3}$。'],
        ans:'$40\\sqrt{3}$' },
      { q:'圓柱底半徑 3、高 7，求體積與表面積（用 $\\pi$）。',
        steps:['體積 $=\\pi\\times 9\\times 7=63\\pi$。','表面積 $=2\\times 9\\pi+2\\pi\\times 3\\times 7=18\\pi+42\\pi=60\\pi$。'],
        ans:'體積 $63\\pi$；表面積 $60\\pi$' } ] },

  { id:'u59c4', title:'圓柱與角柱介紹表', body:
    '<p>4、<b class="key">圓柱</b>：(1) 直圓柱；(2) 斜圓柱；(3) 展開圖＝兩個圓＋一個長方形（長＝底面圓周長）。<b class="key">圓柱的表面積＝兩底面的圓面積和＋底面圓周長 × 高</b>。</p>'+
    '<p>角柱介紹（頂點／面／稜邊）：三角柱 6／5／9；四角柱 8／6／12；五角柱 10／7／15；六角柱 12／8／18；<b class="key">$N$ 角柱：頂點 $2N$、面 $N+2$、稜邊 $3N$</b>。</p>'+
    '<p>規律：<b class="key">頂點＋面－稜邊＝2</b>（尤拉多面體公式）。</p>',
    examples:[
      { q:'八角柱有幾個頂點、幾個面、幾條稜邊？驗證頂點＋面－稜邊。',
        steps:['$N=8$：頂點 16、面 10、稜邊 24。','$16+10-24=2$ ✓。'],
        ans:'16 頂點、10 面、24 稜邊' } ] }
]},

{ id:'u60', book:6, sec:'2-2', title:'角錐與圓錐', page:105, concepts:[
  { id:'u60c1', title:'錐體的體積與表面積', body:
    '<p>錐體（未特別說明，都是<b class="key">正 $n$ 角錐</b>）：</p>'+
    '<p>1、<b class="key">體積＝柱體體積 $\\times\\dfrac{1}{3}$</b>（＝底面積 × 高 × $\\dfrac{1}{3}$）。</p>'+
    '<p>2、<b class="key">表面積＝側面積＋底面積</b>。</p>',
    examples:[
      { q:'四角錐底面積 36、高 10，求體積。',
        steps:['$36\\times 10\\times\\dfrac{1}{3}$。','$=120$。'],
        ans:'$120$' } ] },

  { id:'u60c2', title:'角錐', body:
    '<p>3、<b class="key">角錐</b>：是由一個<b class="key">多邊形</b>底面和數個<b class="key">等腰三角形</b>側面所構成的立體圖形。</p>'+
    '<p>(1) <b class="key">直 $n$ 角錐</b>：<b class="key">錐點垂足在底面</b>；<b class="key">正 $n$ 角錐</b>：<b class="key">底面為正多邊形的直角錐</b>。</p>'+
    '<p>(2) 斜 $n$ 角錐：錐點垂足不在底面中心。</p>'+
    '<p>(3) 展開圖：底面多邊形＋一圈等腰三角形（三角錐、四角錐、五角錐）。</p>',
    examples:[
      { q:'$n$ 角錐有幾個頂點、幾個面、幾條稜邊？',
        steps:['頂點 $n+1$（底 $n$ 個＋錐點）。','面 $n+1$（底 1＋側 $n$）；稜邊 $2n$。','驗證：$(n+1)+(n+1)-2n=2$ ✓。'],
        ans:'$n+1$ 頂點、$n+1$ 面、$2n$ 稜邊' } ] },

  { id:'u60c3', title:'圓錐', body:
    '<p>4、<b class="key">圓錐</b>：(1) <b class="key">直圓錐</b>：<b class="key">錐點垂足在底面，底面為圓形者</b>。(2) 展開圖：一個<b class="key">扇形</b>（側面）＋一個<b class="key">圓</b>（底面）。</p>',
    examples:[
      { q:'直圓錐底半徑 3、母線（斜高）5，側面展開扇形的弧長是多少？高是多少？',
        steps:['扇形弧長＝底圓周長 $=6\\pi$。','高 $=\\sqrt{5^2-3^2}=4$。'],
        ans:'弧長 $6\\pi$；高 4' },
      { q:'承上，求圓錐體積。',
        steps:['底面積 $=9\\pi$，高 4。','$9\\pi\\times 4\\times\\dfrac{1}{3}=12\\pi$。'],
        ans:'$12\\pi$' } ] }
]},

{ id:'u61', book:6, sec:'3-1', title:'次數分配與資料展示', page:108, concepts:[
  { id:'u61c1', title:'統計圖表與資料整理的目的', body:
    '<p>一、統計圖表：1、<b class="key">長條圖</b>（類別資料的比較）；2、<b class="key">直方圖</b>（分組的連續資料，長條相連）；3、<b class="key">折線圖</b>（隨時間變化的趨勢）；4、<b class="key">圓形圖</b>（圓面積圖、圓餅圖——各部分占全體的比例）。</p>'+
    '<p>二、資料整理的<b class="key">目的</b>：<b class="key">將散亂的資料整理成有用、一目了然的資訊</b>。</p>',
    examples:[
      { q:'想呈現「班上同學最喜歡的科目人數」和「某生每次段考成績變化」，各適合哪種圖？',
        steps:['科目是類別比較 → 長條圖。','成績隨時間變化 → 折線圖。'],
        ans:'長條圖；折線圖' } ] },

  { id:'u61c2', title:'次數相關名詞解釋', body:
    '<p>1、<b class="key">次數</b>：各筆或各組資料中數值出現的<b class="key">數量</b>。</p>'+
    '<p>2、<b class="key">累積次數</b>：將<b class="key">次數</b>依資料數值由小至大依序<b class="key">累加</b>，所得到的<b class="key">次數</b>。</p>'+
    '<p>3、<b class="key">相對次數</b>：<b class="key">次數</b>占<b class="key">全體資料次數</b>的<b class="key">百分比</b>。</p>'+
    '<p>4、<b class="key">累積相對次數</b>：<b class="key">相對次數</b>依資料數值由小至大依序<b class="key">累加</b>，所得到的<b class="key">相對次數</b>。</p>',
    examples:[
      { q:'40 人中數學 80 分以上有 10 人，這組的相對次數是多少？',
        steps:['$\\dfrac{10}{40}=25\\%$。'],
        ans:'$25\\%$' },
      { q:'成績分組次數由低到高為 4、10、16、10，前三組的累積次數與累積相對次數（共 40 人）？',
        steps:['累積次數 $=4+10+16=30$。','累積相對次數 $=\\dfrac{30}{40}=75\\%$。'],
        ans:'30；$75\\%$' } ] },

  { id:'u61c3', title:'次數分配表、直方圖、折線圖與累積次數分配表', body:
    '<p>1、<b class="key">次數分配表</b>：把資料分組（如成績每 10 分一組），用計數符號逐筆劃記再統計次數。注意組界：「50～60」指 <b class="key">50 分以上（含 50 分）、未達 60 分（不含 60 分）</b>。</p>'+
    '<p>2、<b class="key">次數分配直方圖</b>：通常直方圖用於表示<b class="key">已分組</b>的資料（長條相連）；座標軸上符號「〃」表示中間部分<b class="key">省略</b>。</p>'+
    '<p>3、<b class="key">次數分配折線圖</b>：<b class="key">組中點：每一組正中間的點</b>。如 $(75,10)$ 表示成績在 70～80 分這組有 10 人。製作折線圖時，以各組的<b class="key">組中點</b>來取折點。</p>'+
    '<p>4、<b class="key">累積次數分配表</b>：把次數由低分組往高分組累加。如 70～80 分有 10 人、累積次數 28 → 表示<b class="key">低於 80 分有 28 人</b>。</p>',
    examples:[
      { q:'成績 60～70 這組的組中點是多少？60 分算在哪組？',
        steps:['組中點 $=\\dfrac{60+70}{2}=65$。','含下界不含上界 → 60 分算在 60～70 組。'],
        ans:'65；60～70 組' },
      { q:'某組累積次數 36、前一組累積次數 28，這組次數是多少？',
        steps:['本組次數＝相鄰累積次數之差。','$36-28=8$。'],
        ans:'$8$' } ] },

  { id:'u61c4', title:'累積折線圖與相對次數圖表', body:
    '<p>5、<b class="key">累積次數分配折線圖</b>：<b class="key">組終點：每一組最右邊的點</b>。製作累積折線圖時，以各組的<b class="key">右端</b>來取折點，這樣才符合累積的意義。如 $(60,10)$ 表示成績<b class="key">未達 60 分</b>的有 10 人；$(30,0)$ 表示沒有人低於 30 分。</p>'+
    '<p>6、相對次數分配表：<b class="key">相對次數 $=\\dfrac{次數}{總次數}\\times 100\\%$</b>。</p>'+
    '<p>7、相對次數分配直方圖、折線圖：折線圖以各組的<b class="key">組中點</b>取折點。</p>'+
    '<p>8、累積相對次數分配表：如 70～80 分占 25%、累積至 80 分為 70% → <b class="key">低於 80 分占 70%</b>。</p>'+
    '<p>9、累積相對次數分配折線圖：以各組<b class="key">右端</b>取折點，如 $(50,15)$ 表示成績未達 50 分的占 15%。</p>',
    examples:[
      { q:'累積折線圖和一般折線圖取點位置有何不同？為什麼？',
        steps:['一般（次數/相對次數）折線圖取組中點。','累積圖取組「右端」——因為累積到該組上界才是完整的累積值。'],
...
{ id:'u62', book:6, sec:'3-2', title:'資料的分析', page:113, concepts:[
  { id:'u62c1', title:'集中與分散的趨勢、算術平均數', body:
    '<p>資料的分析分成兩個部分來討論：(1) <b class="key">集中的趨勢</b>：如何用一個數來代表這一組數字，通常用<b class="key">平均數、中位數</b>與<b class="key">眾數</b>；(2) <b class="key">分散的趨勢</b>：一組資料分散的情形，通常用<b class="key">全距</b>、<b class="key">四分位距</b>等方法來討論（高中會再加標準差）。</p>'+
    '<p>一、<b class="key">算術平均數</b>（易受<b class="key">極端值</b>影響）：</p>'+
    '<p>1、<b class="key">未分組</b>資料：將所有資料的<b class="key">總和</b>除以<b class="key">總個數</b>：平均數 $=\\dfrac{x_1+x_2+\\cdots+x_n}{n}$。</p>'+
    '<div class="inline-ex">例：50、52、54、56、58 的平均數為 $(50+52+54+56+58)\\div 5=54$。</div>'+
    '<p>2、<b class="key">已分組</b>資料：算術平均數 $=\\dfrac{\\sum(組中點\\times 次數)}{總次數}$。</p>'+
    '<div class="inline-ex">例：$\\dfrac{45\\times 3+55\\times 5+65\\times 6+75\\times 8+85\\times 13+95\\times 5}{40}=\\dfrac{2980}{40}=74.5$。</div>',
    examples:[
      { q:'五次小考 80、84、90、76、95，平均幾分？',
        steps:['總和 $=425$。','$425\\div 5=85$。'],
        ans:'85 分' } ] },

  { id:'u62c2', title:'中位數與眾數', body:
    '<p>二、<b class="key">中位數</b>（避免受<b class="key">極端值</b>的影響）：一組由<b class="key">小</b>排到<b class="key">大</b>的資料中，<b class="key">位於正中間</b>位置的數值。</p>'+
    '<p>1、$n$ 為<b class="key">奇數</b>時：中位數為排在<b class="key">正中間</b>的數，即「第 $\\dfrac{n+1}{2}$ 筆資料」。</p>'+
    '<div class="inline-ex">例：10,10,11,13,14,15,15,16,17 的中位數為 <b class="key">14</b>。</div>'+
    '<p>2、$n$ 為<b class="key">偶數</b>時：中位數為排在最中間兩個數的<b class="key">平均</b>，即「第 $\\dfrac{n}{2}$ 筆與第 $\\dfrac{n}{2}+1$ 筆資料的<b class="key">平均</b>」。</p>'+
    '<div class="inline-ex">例：40,42,42,43,45,46 的中位數為 <b class="key">42.5</b>。</div>'+
    '<p>三、<b class="key">眾數</b>（不易受<b class="key">極端值</b>的影響）：<b class="key">出現次數最多的數</b>（由英國統計學家皮爾生首先提出）。當某個資料值出現次數明顯高出其他很多時，以眾數表示較有意義。</p>'+
    '<div class="inline-ex">例：30、32、32、32、34、36、38 的眾數為 <b class="key">32</b>。</div>',
    examples:[
      { q:'資料 3, 7, 8, 9, 100 的平均數與中位數各是多少？哪個較能代表這組資料？',
        steps:['平均 $=127\\div 5=25.4$（被 100 拉高）。','中位數＝第 3 筆 $=8$。','有極端值 100 → 中位數較有代表性。'],
        ans:'平均 25.4；中位數 8；中位數較合適' },
      { q:'鞋店賣出尺寸 24,25,25,26,25,27,24，哪個統計量對進貨最有用？是多少？',
        steps:['最常賣出的尺寸＝眾數。','25 出現 3 次最多。'],
        ans:'眾數 25' } ] },

  { id:'u62c3', title:'設基準點求平均數與資料值的調整', body:
    '<p><b class="key">設基準點求平均數</b>：取一個基準點（如 167.5），把各組中點減基準點後乘次數加總，除以總次數，再加回基準點。</p>'+
    '<div class="inline-ex">例：$(-260)\\div 80=-3.25$，平均 $=167.5-3.25=164.25$。</div>'+
    '<p>四、資料值的調整：</p>'+
    '<p>(1) 將一組資料中的每一個數值都<b class="key">加 $m$</b>（$m\\neq 0$），則新資料的<b class="key">平均數、中位數與眾數</b>是原資料的平均數、中位數與眾數分別再<b class="key">加 $m$</b>。</p>'+
    '<p>(2) 將每一個數值都<b class="key">乘以 $k$ 倍</b>（$k\\neq 0$），則新資料的<b class="key">平均數、中位數與眾數</b>是原資料的分別再<b class="key">乘以 $k$ 倍</b>。</p>',
    examples:[
      { q:'全班某次考試平均 62 分，老師每人加 5 分，新平均是多少？若改為每人乘 1.1 呢？',
        steps:['都加 5 → 平均加 5：67 分。','都乘 1.1 → 平均乘 1.1：68.2 分。'],
        ans:'67 分；68.2 分' } ] },

  { id:'u62c4', title:'百分位數', body:
    '<p>五、<b class="key">百分位數</b> $P_k$（資料的<b class="key">分數</b>情形）：當一群資料個數很多時，比較常用的方式是以 <b class="key">99 個數</b>將整群資料分成 <b class="key">100 等分</b>，這 99 個數稱為<b class="key">百分位數</b>。</p>'+
    '<p>1、百分位數 $P_k$ 就是將資料由小到大排序，<b class="key">至少有 $k\\%$ 的資料 $\\le P_k$</b>，且至少有 <b class="key">$(100-k)\\%$ 的資料 $\\ge P_k$</b>。</p>',
    examples:[
      { q:'會考成績 $P_{88}=95$ 分代表什麼意思？',
        steps:['至少 88% 的人成績 $\\le 95$ 分。','至少 12% 的人成績 $\\ge 95$ 分。'],
        ans:'至少 88% 的人不超過 95 分' } ] },

  { id:'u62c5', title:'百分位數的計算、四分位數與盒狀圖', body:
    '<p>2、未分組資料第 $k$ 百分位數 $P_k$ 的計算方法：&lt;1&gt; 先將資料由小到大排序；&lt;2&gt; 假設資料個數為 $N$，令 $N\\times k\\%=n$：</p>'+
    '<p>(1) 若 $n$ 是<b class="key">整數</b>，則取第 $n$、$(n+1)$ 個資料的<b class="key">平均值</b>當作 $P_k$，即 $P_k=\\dfrac{a_n+a_{n+1}}{2}$。</p>'+
    '<p>(2) 若 $n$ <b class="key">不是整數</b>，取 $n$ 的整數部分再<b class="key">加 1</b> 得到 $m$，則取第 $m$ 個資料當作 $P_k$。</p>'+
    '<p>3、已分組資料：可以利用<b class="key">累積相對次數分配折線圖</b>，找到<b class="key">百分位數</b>所代表的值。</p>'+
    '<p>※ 指考五標：頂標＝第 <b class="key">88</b>、前標＝第 <b class="key">75</b>、均標＝第 <b class="key">50</b>、後標＝第 <b class="key">25</b>、底標＝第 <b class="key">12</b> 百分位數之考生成績。</p>'+
    '<p>六、<b class="key">四分位數</b>：$P_{25}$、$P_{50}$、$P_{75}$ 大約是排在資料 $\\dfrac{1}{4}$、$\\dfrac{2}{4}$、$\\dfrac{3}{4}$ 位置的數，稱為第 1、2、3 四分位數 $Q_1$、$Q_2$、$Q_3$；$Q_2=P_{50}$ 也就是<b class="key">中位數</b>。</p>'+
    '<p>七、<b class="key">盒狀圖</b>：由最小值、$Q_1$、$Q_2$、$Q_3$、最大值五數繪成。八、<b class="key">全距</b>：$Max-Min$。九、<b class="key">四分位距</b>：<b class="key">$Q_3-Q_1$</b>。</p>',
    examples:[
      { q:'20 筆資料求 $P_{25}$：$20\\times 25\\%=5$（整數），怎麼取？',
        steps:['$n=5$ 是整數 → 取第 5、6 筆的平均。'],
        ans:'第 5、6 筆資料的平均' },
      { q:'一組資料 $Q_1=58$、$Q_3=86$，最大 98、最小 40，求全距與四分位距。',
        steps:['全距 $=98-40=58$。','四分位距 $=86-58=28$。'],
        ans:'全距 58；四分位距 28' } ] }
]},

{ id:'u63', book:6, sec:'3-3', title:'機率', page:116, concepts:[
  { id:'u63c1', title:'機率與事件', body:
    '<p>一、<b class="key">機率</b>：假設一個試驗所有可能的結果有 $n$ 種，若每一種結果發生的機會都相等，我們就說每一種結果發生的機率都是<b class="key">相等</b>。</p>'+
    '<p>二、<b class="key">事件</b>：在試驗中，<b class="key">任何想要觀察的情況</b>都可以稱為事件。</p>',
    examples:[
      { q:'擲一顆公正骰子，「出現偶數點」是事件嗎？包含哪些結果？',
        steps:['想觀察的情況就是事件。','包含 2、4、6 三種結果。'],
        ans:'是；含 2、4、6' } ] },

  { id:'u63c2', title:'某事件發生的機率', body:
    '<p>三、如果一個試驗所有可能的結果有 $n$ 種，這 $n$ 種結果發生的機會都相等，若 $A$ 事件包含了其中 $m$ 種（$m\\le n$）可能的結果，我們就說 $A$ 事件發生的機率是 <b class="key">$\\dfrac{m}{n}$</b>。</p>'+
    '<p>(1) $A$ 事件發生的機率 $=\\dfrac{A 事件發生可能}{所有可能}$。</p>'+
    '<p>(2) 任何事件發生的機率都是一個從 <b class="key">0</b> 到 <b class="key">1</b> 的數值。</p>'+
    '<p>(3) 若事件的機率是 <b class="key">1</b>，表示此事件<b class="key">一定會發生</b>。</p>'+
    '<p>(4) 若事件的機率是 <b class="key">0</b>，表示此事件<b class="key">肯定不會發生</b>。</p>',
    examples:[
      { q:'擲一顆公正骰子，出現質數點的機率是多少？',
        steps:['質數點：2、3、5，共 3 種。','$\\dfrac{3}{6}=\\dfrac{1}{2}$。'],
        ans:'$\\dfrac{1}{2}$' },
      { q:'袋中 3 顆紅球 5 顆白球，抽一顆是紅球的機率？抽到「紅或白」的機率？',
        steps:['紅：$\\dfrac{3}{8}$。','紅或白涵蓋所有結果 → 機率 1（一定發生）。'],
        ans:'$\\dfrac{3}{8}$；$1$' } ] },

  { id:'u63c3', title:'樹狀圖', body:
    '<p>四、<b class="key">樹狀圖</b>：把試驗的所有可能結果逐層畫出。</p>'+
    '<div class="inline-ex">例：同時投擲兩枚十元硬幣所有可能的結果——第一枚正／反，各再分第二枚正／反，共 4 種：正正、正反、反正、反反。</div>',
    examples:[
      { q:'同時擲兩枚硬幣，「恰好一正一反」的機率是多少？',
        steps:['樹狀圖共 4 種等可能結果。','一正一反有：正反、反正 2 種 → $\\dfrac{2}{4}=\\dfrac{1}{2}$。'],
        ans:'$\\dfrac{1}{2}$' },
      { q:'擲兩顆骰子，點數和為 12 的機率？',
        steps:['全部 $6\\times 6=36$ 種。','和為 12 只有 $(6,6)$ 1 種 → $\\dfrac{1}{36}$。'],
        ans:'$\\dfrac{1}{36}$' } ] }
]}
